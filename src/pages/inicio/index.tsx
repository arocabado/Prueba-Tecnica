...
const Inicio = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center md:w-3/4 lg:w-2/4 h-full w-full gap-2  sm:px-0 px-2">
          ...
          <button
            className="bg-sky-700 rounded-2xl h-8 sm:w-3/4 w-full hover:bg-sky-800 focus:outline-none text-lg font-bold"
